...
# assumed; the change log carries the four checks. The table itself is generated by
# `tools/gamefiles.py roster --write` from the game's own event scripts, so the names are
# the ones the game prints over the health bar.
_MINIBOSS_CACHE = {}
