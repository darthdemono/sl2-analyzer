...
// InvMixColumns multiplies by only four constants, so the field multiply is a
// lookup, not a loop. These are GENERATED by gmul above — nothing is pasted, so
// there is still no 256-entry table to mistype. This matters: calling gmul here
